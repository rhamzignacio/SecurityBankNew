...
Begin VB.Form frmSBTC 
   ...
   Caption         =   "SBTC 10 Digits (25Pcs / Book on Personal, 25 Pcs / Book on Commercial)"
   ClientHeight    =   4875
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9810
...
Print #1, "                      SBTC Starter 25 Pcs Per Book on Personal"
Print #1, "                     SBTC Starter 25 Pcs Per Book on Commercial"
    ...
    Do Until OrderQty = 0
        ...
        If (DataCount_PA Mod 32 = 0 And ChkType = "A") Or (DataCount_CA Mod 32 = 0 And ChkType = "B") Then
            ...
            If ChkType = "A" Then
                ...
                Print #PrintNumber, "                               STARTER 25 PIECES"
            End If
