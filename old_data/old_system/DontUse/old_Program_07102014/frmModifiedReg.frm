...
Begin VB.Form frmModifiedReg 
   BackColor       =   &H00932B2D&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "For Program Modifications Only :) - REGULAR"
   ClientHeight    =   7215
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   6540
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdReProcessFiles 
         ...
         DisabledPicture =   "frmModifiedReg.frx":030A
         Enabled         =   0   'False
         Height          =   855
         Left            =   3960
         Picture         =   "frmModifiedReg.frx":04CB
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   2040
         Width           =   2295
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmdProcessMeToday 
         ...
         DisabledPicture =   "frmModifiedReg.frx":068C
         Height          =   855
         Left            =   3960
         Picture         =   "frmModifiedReg.frx":08FF
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   720
         Width           =   2295
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdUseExisting 
         ...
         DisabledPicture =   "frmModifiedReg.frx":0B72
         Height          =   855
         Left            =   3960
         Picture         =   "frmModifiedReg.frx":0F0B
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   1080
         Width           =   2295
   ...
   End
End
Attribute VB_Name = "frmModifiedReg"
